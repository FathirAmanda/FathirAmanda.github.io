...
# domain random
CDN="https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/ssh"
cd /root
if [ "${EUID}" -ne 0 ]; then
...
echo -e "$green██║██║░╚███║██████╔╝░░░██║░░░██║░░██║███████╗███████╗  ██████╔╝██████╔╝██║░░██║$NC"
echo -e "$green╚═╝╚═╝░░╚══╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚══════╝  ╚═════╝░╚═════╝░╚═╝░░╚═╝$NC"
echo -e "$green» TERIMAKASIH TELAH MEMAKAI AUTOSCRIPT PREMIUM DP-VPN$NC"
sleep 5
echo -ne "[ ${green}INFO${NC} ] Check permission : "
mkdir -p /var/lib/SIJA >/dev/null 2>&1
echo "IP=" >> /var/lib/SIJA/ipvps.conf
echo ""
wget -q https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo " "
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
wget -q -O slow.sh https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/slow.sh && chmod +x slow.sh && ./slow.sh
clear
cat> /root/.profile << END
if [ "$BASH" ]; then
if [ -f ~/.bashrc ]; then
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/version )
...
echo "" | tee -a log-install.txt
echo "------------------------------------------------------------" | tee -a log-install.txt
echo "===============-[ Script By dpvpn ]-==============" | tee -a log-install.txt
echo ""
echo ""
rm /root/setup.sh >/dev/null 2>&1
