#!/bin/bash
BURIQ () {
curl -sS https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/register | grep $MYIP | awk '{print $2}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/register | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/version)
