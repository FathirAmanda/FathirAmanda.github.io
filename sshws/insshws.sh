...
#wget -O /etc/systemd/system/ws-openssh.service https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/sshws/service-wsopenssh && chmod +x /etc/systemd/system/ws-openssh.service

#System Dropbear Websocket-SSH Python
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service
