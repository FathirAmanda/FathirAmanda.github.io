...
function checking_sc() {
    ...
    IZIN=$(curl -sS https://dpvpn.me/register | awk '{print $4}')
...
cd /media/
rm -rf cybervpn
wget https://dpvpn.me/botol/cybervpn.zip
unzip cybervpn.zip
cd cybervpn
rm var.txt
rm database.db
...
wget -q -O /media/log-install.txt "https://dpvpn.me/botol/log-install.txt"
