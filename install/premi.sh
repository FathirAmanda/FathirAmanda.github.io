...
data_ip="https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/dpvpn009"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
