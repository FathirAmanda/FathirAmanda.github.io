...
cd /usr/bin
wget https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/FathirAmanda/FathirAmanda.github.io/refs/heads/main/install/bot/kyt.zip
unzip kyt.zip
