...
wget -q -O /usr/bin/proxy3.js "https://dpvpn.me/ssh/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://dpvpn.me/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
